<template>
  <el-dialog v-model="modalState" width="650px" :title="data ? '编辑字典类型' : '新增字典类型'" :close-on-press-escape="false" :close-on-click-modal="false">
...
<script lang="ts" setup name="dictAction">
import type { DictResponseType } from '@/apis/dict';

import { ElButton, ElMessage } from 'element-plus';

import { fromData } from './dictFromData';
