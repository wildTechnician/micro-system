  ...
  <div class="fc-style">
    <el-container class="fc-container">
        ...
        <el-container>
          ...
          <el-main class="center-container">
            ...
            <el-main :class="{ 'widget-empty': widgetForm.list }">
              <WidgetForms ref="widgetFormRef" v-model:widgetForm="widgetForm" v-model:widgetFormSelect="widgetFormSelect" />
            </el-main>
          </el-main>
          <el-aside class="widget-config-container" width="300px">
            <el-container>
              ...
              <el-main class="config-content">
                <WidgetConfig v-show="configTab === 'widget'" v-model:select="widgetFormSelect" />
                <FormConfig v-show="configTab === 'form'" v-model:config="widgetForm.config" />
              </el-main>
            </el-container>
          </el-aside>
        </el-container>
      ...
      <el-dialog v-model="previewVisible" title="预览" :width="800">
        <GenerateForm v-if="previewVisible" ref="generateFormRef" :data="widgetForm" />
        <template #footer>
      ...
      <el-dialog v-model="dataCodeVisible" title="生产代码" :width="800">
        <el-tabs v-model="codeLanguage" type="card" :tab-bar-style="{ margin: 0 }">
...
import WidgetForms from './WidgetForm.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    const getTemplate = (codeType: CodeType) => generateCode(state.widgetForm, codeType, PlatformType.Element);
