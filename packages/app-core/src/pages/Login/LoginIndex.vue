...
import { loginApi } from '@packages/utils-common/apis/permission';
...
import { useCookies, useAsync } from '@packages/utils-common/hook';
import { version } from '../../../package.json';
import { Essential } from '@packages/utils-common/enum';

import type { LoginRequestType } from '@packages/utils-common/apis/permission';
...
.container {
  ...
  position: fixed;
  top: 0;
  @include loadImage('/login/init.png') {
...
.login-header {
  ...
  .title {
    ...
    font-weight: bold;
    padding: 16px 50px;
    @include loadImage('/login/headerBg.png') {
      background-repeat: no-repeat;
      background-position: center;
