<template>
  <el-dialog v-model="modalState" width="650px" :title="data ? '编辑版本' : '新增版本'" :close-on-press-escape="false" :close-on-click-modal="false">
...
<script lang="ts" setup name="versionAction">
import type { VersionResponseType } from '@/apis/version';

import { ElButton, ElMessage } from 'element-plus';

import { fromData } from './versionFromData';
...
type FromType = Pick<VersionResponseType, 'nickname'>;
...
const coverData = (data: Partial<VersionResponseType>) => {
